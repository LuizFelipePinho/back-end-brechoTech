// import { EntityRepository, Repository } from 'prisma';
...
// import { FindUserQueryDto } from './dtos/find-users-query.dto';
...
// //     if (name) query.andWhere('user.name ILIKE :name', { name: %${nome}% });
